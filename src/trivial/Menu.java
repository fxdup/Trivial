    ...
    private void Options() throws FileNotFoundException {
        ...
        switch (resolution) {
            case 1:
                ...
                break;
            case 2:
                resolution_text = "x 3/4";
                break;
            case 3:
                resolution_text = "x 2/3";
                break;
            case 4:
                resolution_text = "x 1/2";
                break;
        }
        oldSound = sound;
        ...
        resolution_button.setOnMouseClicked(e -> {
            ...
            switch (resolution) {
                case 1:
                    resolution = 2;
                    resolution_button.setText("Size: x 3/4");
                    break;
                case 2:
                    resolution = 3;
                    resolution_button.setText("Size: x 2/3");
                    break;
                case 3:
                    resolution = 4;
                    resolution_button.setText("Sixe: x 1/2");
                    break;
                case 4:
                    resolution = 1;
                    resolution_button.setText("Size: x 1");
                    break;
            }
        });
